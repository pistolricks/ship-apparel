...
const AthleticView: Component<{
    ...
    const images = () => [product()?.main_image_url, product()?.main_image_url, product()?.other_image_url]


    const details = () => [`Brand: ${product()?.brand}`, `Style: ${product()?.item_sku}`]
                        ...
                        <div class="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
                            <div class="lg:col-span-5 lg:col-start-8">
                                <div class="flex justify-between">
                                    <h1 class="text-xl font-medium text-gray-900">{product()?.item_name}</h1>
