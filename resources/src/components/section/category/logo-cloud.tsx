            ...
            <div class="py-32">
                <div class="mx-auto px-6 max-w-5xl">
                    <div class="text-center">
                        <h2 class="text-3xl text-gray-950 dark:text-white font-semibold">Seamlessly integrates
                            with <br/> your favorite frontend tools</h2>
                    ...
                    <div class="mt-12 relative w-fit h-fit sm:mx-auto sm:px-0 -mx-6 px-6 overflow-x-auto">
                        <div class="mb-3 flex w-fit mx-auto gap-3">
                            <div
                                class="card variant-mixed bg-ui flex relative *:relative *:size-7 *:m-auto size-20 mx-auto ">
                            ...
                            <div
                                class="card variant-mixed bg-ui flex relative *:relative *:size-7 *:m-auto size-20 mx-auto ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="0.84em" height="1em"
                                     viewBox="0 0 256 308">
                                    <path fill="#ff3e00"
                            ...
                            <div
                                class="card variant-mixed bg-ui flex relative *:relative *:size-7 *:m-auto size-20 mx-auto ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.53em" height="1em"
                                     viewBox="0 0 256 168">
                                    <path fill="#00dc82"
                        ...
                        <div class="my-3 flex w-fit mx-auto gap-3">
                            ...
                            <div
                                class="card variant-mixed bg-ui flex relative *:relative *:size-7 *:m-auto size-20 mx-auto ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="0.81em" height="1em"
                                     viewBox="0 0 256 317">
                                    <defs>
                                        <linearGradient id="logosFlutter0" x1="3.952%" x2="75.897%" y1="26.993%"
                                                        y2="52.919%">
                                            <stop offset="0%"/>
                                            <stop offset="100%" stop-opacity="0"/>
                                        </linearGradient>
                                    ...
                                    <path fill="url(#logosFlutter0)" fill-opacity="0.8"
                        ...
                        <div class="flex w-fit mx-auto gap-3">
                            ...
                            <div
                                class="card variant-mixed bg-ui flex relative *:relative *:size-7 *:m-auto size-20 mx-auto ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.12em" height="1em"
                                     viewBox="0 0 256 229">
                                    <path fill="#0066da"
                            ...
                            <div
                                class="card variant-mixed bg-ui flex relative *:relative *:size-7 *:m-auto size-20 mx-auto ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.56em" height="1em"
                                     viewBox="0 0 256 165">
                                    <path fill="#0364b8"
                        ...
                        <div class="mt-3 flex w-fit mx-auto gap-3">
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 128 128">
                                    <defs>
                                        <linearGradient id="deviconKotlin0" x1="500.003" x2="-.097" y1="579.106"
                                                        y2="1079.206"
