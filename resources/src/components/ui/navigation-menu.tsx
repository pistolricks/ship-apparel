  ...
  return (
    <NavigationMenuPrimitive.Icon aria-hidden="true">
      <svg
        ...
        class="relative top-px size-3 transition duration-200 group-data-[expanded]/trigger:rotate-180 group-data-[orientation=vertical]/menu:-rotate-90 group-data-[orientation=vertical]/menu:group-data-[expanded]/trigger:rotate-90"
      >
        <path d="M6 9l6 6l6 -6" />
      </svg>
...
const NavigationMenuLink = <T extends ValidComponent = "a">(
  ...
  return (
    <NavigationMenuPrimitive.Item
      class={cn(
        "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors  hover:text-content/50 focus:bg-bgBase/80 focus:text-content",
        local.class
      )}
      {...others}
    />
...
const NavigationMenuDescription = <T extends ValidComponent = "div">(
  ...
  return (
    <NavigationMenuPrimitive.ItemDescription
      class={cn("text-sm leading-snug text-content/80", local.class)}
      {...others}
    />
  )
}
