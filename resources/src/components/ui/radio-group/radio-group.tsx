...
const RadioGroupItem = <T extends ValidComponent = "div">(
    ...
    return (
        <RadioGroupPrimitive.Item class={cn("flex items-center", local.class)} {...others}>
            <RadioGroupPrimitive.ItemInput />
            <RadioGroupPrimitive.ItemControl class="absolute rounded-full aspect-square h-10 border border-primary text-primary outline-offset-background focus:outline-hidden focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
