  ...
  return (
    <Dialog {...others}>
      <DialogContent class="overflow-hidden p-0">
        <Command class="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:ink-color-text-secondary [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:size-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:size-5">
          {local.children}
        </Command>
      </DialogContent>
    </Dialog>
  ...
  return (
    <div class="flex items-center border-b px-3" cmdk-input-wrapper="">
      ...
      <CommandPrimitive.CommandInput
        class={cn(
          "flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-none placeholder:ink-color-text-secondary disabled:cursor-not-allowed disabled:opacity-50",
          local.class
        )}
        {...others}
      />
...
const CommandGroup: Component<ParentProps<CommandPrimitive.CommandGroupProps>> = (props) => {
  ...
  return (
    <CommandPrimitive.CommandGroup
      class={cn(
        "overflow-hidden p-1 text-foreground [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:ink-color-text-secondary",
        local.class
      )}
      {...others}
    />
...
const CommandShortcut: Component<ComponentProps<"span">> = (props) => {
  ...
  return (
    <span
      class={cn("ml-auto text-xs tracking-widest ink-color-text-secondary", local.class)}
      {...others}
    />
  )
}
