                ...
                <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
                    <div>
                        <div>
                            ...
                            <div class="mt-4">
                                <label id="email-address" class="block text-sm/6 font-medium text-gray-700">
                                    Email address
                                </label>
                                <div class="mt-2">
                                    <input
                        ...
                        <div class="mt-10 border-t border-gray-200 pt-10">
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                <div>
                                    <label id="first-name" class="block text-sm/6 font-medium text-gray-700">
                                        First name
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div>
                                    <label id="last-name" class="block text-sm/6 font-medium text-gray-700">
                                        Last name
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div class="sm:col-span-2">
                                    <label id="company" class="block text-sm/6 font-medium text-gray-700">
                                        Company
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div class="sm:col-span-2">
                                    <label id="address" class="block text-sm/6 font-medium text-gray-700">
                                        Address
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div class="sm:col-span-2">
                                    <label id="apartment" class="block text-sm/6 font-medium text-gray-700">
                                        Apartment, suite, etc.
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div>
                                    <label id="city" class="block text-sm/6 font-medium text-gray-700">
                                        City
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div>
                                    <label id="country" class="block text-sm/6 font-medium text-gray-700">
                                        Country
                                    </label>
                                ...
                                <div>
                                    <label id="region" class="block text-sm/6 font-medium text-gray-700">
                                        State / Province
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div>
                                    <label id="postal-code" class="block text-sm/6 font-medium text-gray-700">
                                        Postal code
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div class="sm:col-span-2">
                                    <label id="phone" class="block text-sm/6 font-medium text-gray-700">
                                        Phone
                                    </label>
                                    <div class="mt-2">
                                        <input
                        ...
                        <div class="mt-10 border-t border-gray-200 pt-10">
                            <fieldset>
                                ...
                                <RadioGroup
                                    value={selectedDeliveryMethod().title}
                                    onChange={setSelectedDeliveryMethod}
                                    class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4"
                                >
                                    <For each={deliveryMethods}>
                                        {(deliveryMethod) => (
                                            <RadioGroup.Item
                                                value={deliveryMethod.title}
                                                aria-label={deliveryMethod.title}
                                                aria-description={`${deliveryMethod.turnaround} for ${deliveryMethod.price}`}
                                                class="group relative flex cursor-pointer rounded-lg border border-gray-300 bg-white p-4 shadow-sm focus:outline-none data-[checked]:border-transparent data-[focus]:ring-2 data-[focus]:ring-indigo-500"
                                            >
                      <span class="flex flex-1">
                        <span class="flex flex-col">
                          ...
                          <span class="mt-6 text-sm font-medium text-gray-900">{deliveryMethod.price}</span>
                                                ...
                                                <span
                                                    aria-hidden="true"
                                                    class="pointer-events-none absolute -inset-px rounded-lg border-2 border-transparent group-data-[focus]:border group-data-[checked]:border-indigo-500"
                                                />
                                            </RadioGroup.Item>
                                        )}
                                    </For>
                        ...
                        <div class="mt-10 border-t border-gray-200 pt-10">
                            ...
                            <div class="mt-6 grid grid-cols-4 gap-x-4 gap-y-6">
                                <div class="col-span-4">
                                    <label id="card-number" class="block text-sm/6 font-medium text-gray-700">
                                        Card number
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div class="col-span-4">
                                    <label id="name-on-card" class="block text-sm/6 font-medium text-gray-700">
                                        Name on card
                                    </label>
                                    <div class="mt-2">
                                        <input
                                ...
                                <div class="col-span-3">
                                    <label id="expiration-date" class="block text-sm/6 font-medium text-gray-700">
                                ...
                                <div>
                                    <label id="cvc" class="block text-sm/6 font-medium text-gray-700">
                                        CVC
                                    </label>
                                    <div class="mt-2">
                                        <input
