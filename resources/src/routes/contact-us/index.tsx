...
const ContactUs: Component<PROPS> = props => {
    return (
        <div class="relative isolate bg-white">
            <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                <div class="relative px-6 pb-12 pt-24 sm:pt-24 lg:static lg:px-8 lg:py-28">
                    <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        <h2 class="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Get in
                            touch</h2>
                        <p class="mt-6 text-lg/8 text-gray-600">
                            We’d love to hear from you! Whether you have questions, feedback, or need assistance, our team is here to help. Feel free to get in touch with us through our contact page, or reach out via phone or email. We are committed to providing you with excellent service and will respond as quickly as possible. Your thoughts and inquiries matter to us, so don’t hesitate to connect today!
                        </p>
                        <dl class="mt-10 space-y-4 text-base/7 text-gray-600">
                            <div class="flex gap-x-4">
                                ...
                                <dd>4000 S. Broadway<br/>Los Angeles, CA 90037</dd>
                            </div>
                            <div class="flex gap-x-4">
                                <dt class="flex-none">
                                ...
                                <dd><a class="hover:text-gray-900" href="tel:+1 (555) 234-5678">+1 (747) 333-7919</a>
                                </dd>
                            </div>
                            <div class="flex gap-x-4">
                                <dt class="flex-none">
                                ...
                                <dd><a class="hover:text-gray-900" href="mailto:hello@example.com">info@custominkandthread.com</a>
                                </dd>
                            </div>
                        </dl>
                    </div>
                </div>
                <form action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-28">
