...
<input {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge(['class' => "px-3 py-2 block w-full rounded-none rounded-l-md border-gray-300 focus:border-gray-300 focus:ring-gray-200 sm:text-sm"]) !!}>
