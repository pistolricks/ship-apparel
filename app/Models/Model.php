...
abstract class Model implements HasMedia, Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, Stringable, UrlRoutable
{
     ...
     */
    protected static string $collectionClass = EloquentCollection::class;
     ...
     */
    public function newPivot(self|\Illuminate\Database\Eloquent\Model $parent, array $attributes, $table, $exists, $using = null)
    {
    ...
    public function __call($method, $parameters)
    {
        ...
        if (Str::startsWith($method, 'through') &&
            method_exists($this,
                $relationMethod = (new SupportStringable($method))->after('through')->lcfirst()->toString())) {
