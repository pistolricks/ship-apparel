...
class ProductsImport2 implements ToModel, WithHeadingRow, WithBatchInserts, WithSkipDuplicates, WithChunkReading, WithStartRow, \Illuminate\Contracts\Queue\ShouldQueue
{
